    ...
    async run() {
        ...
        if (this.tokenMetadata !== undefined) {
            const { useToken } = await this.prompt({
                ...
                name: "useToken",
                default: true,
                message: this.formatQuestion(`Found a Segment Token for workspace ${(_a = this.tokenMetadata.workspace) === null || _a === void 0 ? void 0 : _a.name} on ${(0, config_1.tokenMethodToUserString)(this.tokenMetadata.method, this.configPath)}`),
                choices: [
                    {
                        name: "Use this token",
                        value: true,
        ...
        const { trackingPlans } = await this.prompt({
            ...
            choices: planChoices,
            default: (_b = this.workspaceConfig) === null || _b === void 0 ? void 0 : _b.trackingPlans.map((t) => t.id),
            validate: (selection) => {
        ...
        for (const trackingPlan of trackingPlans) {
            const { path } = await this.prompt({
                ...
                default: (_d = (_c = this.workspaceConfig) === null || _c === void 0 ? void 0 : _c.trackingPlans.find((t) => t.id === trackingPlan.id)) === null || _d === void 0 ? void 0 : _d.path,
            });
        ...
        const { language } = await this.prompt([
            {
                ...
                default: languages_1.supportedLanguages.find((lang) => { var _a; return lang.id === ((_a = this.workspaceConfig) === null || _a === void 0 ? void 0 : _a.client.language); }),
            },
        ]);
        const { sdk } = await this.prompt([
            {
                ...
                default: (_e = this.workspaceConfig) === null || _e === void 0 ? void 0 : _e.client.sdk,
            },
        ]);
        ...
        const mergedConfig = {
            ...
            client: {
                ...(_f = this.workspaceConfig) === null || _f === void 0 ? void 0 : _f.client,

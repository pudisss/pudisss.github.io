 ...
 */
export declare type CodeGenerator = (renderer: ConvenienceRenderer) => void;
/**
...
export declare type FileGenerateResult = ReadonlyMap<string, string>;
export interface LanguageGenerator {
     ...
     */
    generate: (rules: SegmentAPI.RuleMetadata[], context: TemplateContext, options: GeneratorOptions) => Promise<FileGenerateResult>;
}

...
function addPrefixAndSuffix(name, prefix, suffix) {
    return `${prefix !== null && prefix !== void 0 ? prefix : ""} ${name} ${suffix !== null && suffix !== void 0 ? suffix : ""}`;
}
/**
...
function makeNameForTopLevelWithPrefixAndSuffix(namer, typewriterSettings, t, givenName, maybeNamedType) {
    var _a;
    const { prefix, suffix } = (_a = typewriterSettings.typeNameModifiers) !== null && _a !== void 0 ? _a : {};
        ...
        return (renderer) => {
            ...
            renderer.forEachTopLevel("none", (type, name) => {
                ...
                tags.type.push({
                    ...
                    // @ts-ignore
                    description: (_a = renderer.descriptionForType(type)) === null || _a === void 0 ? void 0 : _a.join(" "),
                    // @ts-ignore
                    functionName: renderer.sourcelikeToString((0, quicktype_core_1.modifySource)((_b = nameModifiers === null || nameModifiers === void 0 ? void 0 : nameModifiers.functionName) !== null && _b !== void 0 ? _b : Strings_1.originalWord, name)),
                    // @ts-ignore
    ...
    return {
        ...
        generate: async (rules, context, options) => {
            ...
            if (templatePath === undefined) {
                ...
                const mods = {
                    functionName: modWithPrefixAndSuffix(prefixes === null || prefixes === void 0 ? void 0 : prefixes.functionName, suffixes === null || suffixes === void 0 ? void 0 : suffixes.functionName, nameModifiers === null || nameModifiers === void 0 ? void 0 : nameModifiers.functionName),
                };
            ...
            return generateWithQuicktype(new quicktypeLanguage({
                ...
                typeNameModifiers: {
                    prefix: prefixes === null || prefixes === void 0 ? void 0 : prefixes.typeName,
                    suffix: suffixes === null || suffixes === void 0 ? void 0 : suffixes.typeName,
                },

...
async function saveWorkspaceConfig(config, path) {
    ...
    for (const plan of trackingPlans.items) {
        const id = (_a = plan.get("id")) === null || _a === void 0 ? void 0 : _a.toString();
        ...
        const name = (_b = plan.get("name")) === null || _b === void 0 ? void 0 : _b.toString();
        plan.delete("name");
...
function tokenMethodToUserString(method, configPath) {
    ...
    if (method === TokenMethod.Script) {
        return `${configPath !== null && configPath !== void 0 ? configPath : "."}/${exports.CONFIG_NAME}`;
    }
    return "~/.typewriter";
}
...
async function getScriptToken(config, configPath, validate = true) {
    var _a;
    if (((_a = config === null || config === void 0 ? void 0 : config.scripts) === null || _a === void 0 ? void 0 : _a.token) === undefined) {
        return {

...
class BaseCommand extends core_1.Command {
    ...
    get apiToken() {
        var _a, _b;
        return (_b = (_a = this.tokenMetadata) === null || _a === void 0 ? void 0 : _a.token) !== null && _b !== void 0 ? _b : undefined;
    }
    get workspace() {
        var _a;
        return (_a = this.tokenMetadata) === null || _a === void 0 ? void 0 : _a.workspace;
    }
    get rawCommand() {
    ...
    async init() {
        ...
        if ((tokenMetadata === null || tokenMetadata === void 0 ? void 0 : tokenMetadata.token) !== undefined) {
        ...
        if (this.apiToken !== undefined &&
            ((_a = this.workspaceConfig) === null || _a === void 0 ? void 0 : _a.trackingPlans.some((tp) => tp.id.trimStart().startsWith("rs_")))) {
    ...
    async finally(error) {
        ...
        (_a = ttys_1.ttys.stdout) === null || _a === void 0 ? void 0 : _a.destroy();
        (_b = ttys_1.ttys.stdin) === null || _b === void 0 ? void 0 : _b.destroy();
    }
}
